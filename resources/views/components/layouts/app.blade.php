        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item "><a class="nav-link " href="{{route('students')}}" wire:navigate>Students</a></li>
                </ul>
                ...
                <div class="footer-widget">
                    ...
                    <ul class="list-unstyled">
                        @foreach(getServices() as $service)
                            <li class="mb-2"><a href="{{route('servicePage', $service->id)}}" wire:navigate>{{$service->title}}</a>
                            </li>
                        @endforeach                        
                    </ul>
                </div>
